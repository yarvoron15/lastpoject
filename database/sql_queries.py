...
INSERT_DIS_QUERY = """
INSERT INTO dis_profile VALUES (?,?,?)
"""

SELECT_LEFT_JOIN_PROFILE_QUERY = """
SELECT * FROM profile
LEFT JOIN dis_profile ON profile.TELEGRAM_ID = dis_profile.OWNER_TELEGRAM_ID
AND dis_profile.LIKER_TELEGRAM_ID = ?
WHERE dis_profile.ID IS NULL
AND profile.TELEGRAM_ID != ?
"""
...
UPDATE profile SET NICKNAME = ?, BIO = ?, AGE = ?, MARRIED = ?,LOCATION = ?,HOBBY = ?, GENDER = ?, PHOTO = ? WHERE TELEGRAM_ID = ?
"""